  ...
  .then(data => {
    ...
    fetch(`https://idreambooks.com/api/books/reviews.json?q=${isbn}&key=71a6da4aabaeb74d7e1ea1087ed441f152eacbe0`)
      ...
      .then(data => {
        ...
        document.querySelector('.anchor').textContent = reviewLink;
      })
    });
}
...
//   event.preventDefault()
// })
// https://idreambooks.com/api/books/reviews.json?q=${isbn}&key=71a6da4aabaeb74d7e1ea1087ed441f152eacbe0
//
// https://idreambooks.com/api#book_json
// 71a6da4aabaeb74d7e1ea1087ed441f152eacbe0
